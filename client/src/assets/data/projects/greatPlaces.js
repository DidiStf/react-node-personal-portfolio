...
export const greatPlaces = {
  ...
  description: {
    ...
    [LOCALES.FRENCH]:
      "Application Mobile, développée en React-Native, qui utilise les modules integrés au dispositif comme la caméra, le gps et le système de stockage interne. L'Application permet à l'utilisateur de créer un album personnel en prenant une photo (d'un endroit, monument, etc.) et en la sauvegardant sur le téléphone avec ses coordonnées géographiques.",
    [LOCALES.SPANISH]:
