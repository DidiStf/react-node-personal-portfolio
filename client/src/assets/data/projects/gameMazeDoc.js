...
export const gameMazeDoc = {
  ...
  description: {
    ...
    [LOCALES.FRENCH]:
      'Documentation détaillée pour l\'API REST Game Maze, élaborée pour un de mes porjets de fin d\'études. Elle contient toutes les informations nécessaires pour l\'utilisation de l\'API Game Maze, comme les "endpoints", les requêtes HTTP disponibles, les "headings", les paramettres, les réponses, les erreurs et les permissions.',
    [LOCALES.SPANISH]:
    ...
    [LOCALES.BULGARIAN]:
      'Подробна докумнетация за REST уеб апликацията (API) Game Maze, изготвена като част от един от дипломните ми проекти. Тя съдържа цялата информация необходима за използването на back-end приложението (ендпойнтс, HTTP заявки, параметри, отговори, грешки, разрешения ит.н.)',
  },
  images,
