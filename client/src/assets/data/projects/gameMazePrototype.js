...
export const gameMazePrototype = {
  ...
  description: {
    ...
    [LOCALES.FRENCH]:
      "Une maquette interactive de l'Application Mobile Game Maze, elaborée avec AdobeXD en tant que part d'un de mes projets de fin d'études. La maquette montre la plupart des fonctionnalités de l'application qui est une sorte de reaseau social pour les \"gamers\" où les utilisateurs peuvent trouver des informations sur différents jeux vidéos. Ils peuvent également créer un compte pour commenter et noter les jeux et pour contacter le reste des utilisateurs à travers le système de messagerie interne. Les administrateurs peuvent gérer les informations concernant les jeux vidéos et les super administrateurs peuvent supprimer des comptes utilisateur ainsi que attribuer ou enlever des droits d'administrateur.",
    [LOCALES.SPANISH]:
      'Un modelo interactivo de la Aplicaión Móvil Game Maze, hecho con AdobeXD como parte de uno de mis proyectos de fin de carrera. El modelo demuestra la mayoría de las funciones de la aplicación que es una especie de red soacial para "gamers" donde los usuarios pueden encontrar información sobre varios videojuegos. Ellos pueden también crear una cuenta para comentar y evaluar los juegos y para contactar el resto de los usuarios a través del sistema de mensajería interno. Los administradores pueden administrar los datos de los juegos y los super administradores pueden suprimir las cuentas así que dar o quitar derechos de administrador a los usuarios.',
    [LOCALES.BULGARIAN]:
