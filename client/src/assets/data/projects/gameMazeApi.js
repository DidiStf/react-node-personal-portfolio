...
export const gameMazeApi = {
  ...
  description: {
    [LOCALES.ENGLISH]:
      "REST API that I developed as part of my graduation projects called Game Maze. It gives access to detailed information about various video games. It also contains other information such as users' comments, ratings and messages and serves as a back-end for the Game Maze mobile app project.",
    [LOCALES.FRENCH]:
