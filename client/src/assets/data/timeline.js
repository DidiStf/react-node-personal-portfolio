...
const data = {
  [LOCALES.ENGLISH]: [
    ...
    },
    {
      ...
      location: 'Nice, France',
      title: 'Web and Mobile Application Design and Development',
    ...
    },
    {
      ...
      description:
        "I took part in the development of the UI of a web platform that uses Artificial Intelligence and Psychology to improve the performance of the organizations through their collaborator's engagement. (Vue.js, Element UI, JavaScript, CSS/Sass, Bootstrap, HTML)",
    ...
    },
    {
      ...
      description:
        'Technical support agent for the American company Fitbit. Support in Spanish, English and French via phone, email and over the social networks.',
    ...
    },
    {
      ...
      description: 'Spanish Linguistics (Erasmus studies)',
  ...
  [LOCALES.FRENCH]: [
    ...
    },
    {
      ...
      description:
        "J'ai participé au développemnt de l'interface utilisateur d'une plate-forme web qui unit Intelligence Artificielle and Psychologie afin d'evaluer et améliorer la performance des entreprises à travers l'engagement de leurs collaborateurs. (Vue.js, Element UI, JavaScript, CSS/Sass, Bootstrap, HTML)",
    ...
    },
    {
      ...
      title: 'Spécialiste en Support Technique (Fitbit)',
      description:
    ...
    {
      institution: 'Unversité de Valence',
      location: 'Valence, Espagne',
      title: 'Lettres Hispaniques et Hispano-Américaines',
      description: "Étides d'Erasmus en Lettres Hispaniques",
  ...
  [LOCALES.SPANISH]: [
    ...
    },
    {
      ...
      description: 'Estudios de Erasmus en Linguística Hispánica',
  ...
  [LOCALES.BULGARIAN]: [
    ...
    },
    {
      ...
      description:
        'Technical Support Specialist с Испански, Френски и Английски (телефон, имейл, социални мрежи).',
