  ...
  return (
    <div className="AboutInfo">
      ...
      <p className="AboutInfo_info">
        ...
        <br />
        <br />
        I mainly run on VS code and good coffee. I'm highly motivated and
        passionate about learning new skills and best practices. I also like
        keeping me up to date with the latest technologies and trying them by
        building different projects.
        <br />
        <br />
        <strong>Interests:</strong> video games, retro gaming consoles, board
        games, electronics, languages and new technologies. Well, I'm a geek.
      </p>
    </div>
  );
};
